...
class OphScImagehumphreysModule extends BaseEventTypeModule
{
	...
	public function init() {
		...
		$this->setImport(array(
			'OphScImagehumphreys.models.*',
			'OphScImagehumphreys.components.*',
		));
		
		$this->moduleShortSuffix = "imagehumphreys";
	}
